      ...
      <main style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to UniLend LTD, BVI.
          </li>
          <li>
          ...
          <li>
            <strong>Country</strong> refers to: British Virgin Islands.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Numa Network, accessible from{' '}
            <a href='https://app.numa.network/'>https://app.numa.network/</a>.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            services You have purchased or any other contract with Us through
            the Service.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            Your personal information during negotiations of a merger, sale of
        ...
        <p>
          ...
          Base or other blockchain funds and initiate transactions is stored
        ...
        <p>
          ...
          chosen to include in a given transaction.
        </p>
        <p>
        ...
        <p>By email: help@unilend.finance</p>
      </main>
    </div>
  );
}
