...
export default function TermsOfUse() {
  return (
    <main className='termsOfUseContainer'>
      <h1>TERMS OF USE</h1>
      <p className='last-updated'>Last updated: November 21, 2024</p>
      <h3>AGREEMENT TO OUR LEGAL TERMS</h3>
      <p>
        We are UniLend LTD (<span>"Company," "we," "us," "our"</span>), a
        company registered in BVI. We operate the website{" "}
        <a href='https://app.numa.network' target='_blank'>
          https://app.numa.network
        </a>{" "}
        (the <span>"Site"</span>), as well as any other related products and
        services that refer or link to these legal terms (the{" "}
        <span>"Legal Terms"</span>) (collectively, the <span>"Services"</span>).
      </p>
      <p>
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (<span>"you"</span>),
        and UniLend LTD, concerning your access to and use of the Services. By
      ...
      <p>
        <strong>
          Our Services are NOT offered to persons or entities who reside in, are
      ...
      <p>
        ...
        appropriate network (<span>"Gas Fees"</span>). Except as otherwise
        expressly set forth in the terms of another offer by UniLend LTD, you
        will be solely responsible to pay the Gas Fees for any transaction that
        you initiate via any of our Services.
      </p>
      <h3>Blockchain Networks Transactions</h3>
      <p>
        In order to be completed, all transactions with cryptocurrency, digital
        tokens or digital assets (“virtual currency”) must be confirmed and
        recorded in the associated public blockchain. Such networks are
        decentralized, peer-to-peer networks supported by independent third
        parties, which we do not own, control, or operate. We have no control
        over the Blockchain Networks and, therefore, cannot and do not ensure
        that any transaction details that you submit via the Interface will be
        confirmed and processed. By using the Interface, you acknowledge and
        agree that the transaction details you submit may not be completed, or
        may be substantially delayed, by the Blockchain Networks
      </p>
      <p>
        We do not store, transfer, transmit, convert, broker, hold, escrow,
        mint, mine, or otherwise interact with any virtual currency, security,
        ...
        connection with any virtual currency transaction initiated via the
        Interface. We strongly encourage you to review your transaction details
        carefully before attempting to transfer a virtual currency.
      </p>
      <p>
        Completion of transactions that you instruct for through the Interface
        also depends on the availability and operation of the Blockchain
        Networks. Errors or forks in the Blockchain Networks may cause
        transactions that you initiate through the Interface to fail. This may
        mean that the transaction you were originally intending to perform will
        no longer be available. Unfortunately, due to the decentralized nature
        of the Blockchain Networks, there is no one single point of failure, and
        so neither we nor any particular party will be responsible to you for
        errors or any losses that you suffer as a result.
      </p>
      <h3>Additional Terms</h3>
      <p>
        Certain products accessible through the Interface, including related
        applications, may be subject to additional terms. Such additional terms
        are an integral part of these Terms of Use. However, in the event of a
      ...
      <p>
        ...
        in the Services (collectively, the <span>"Content"</span>), as well as
      ...
      <p>
        ...
        <a href='mailto:help@unilend.finance'>help@unilend.finance</a>. If we
      ...
      <p>
        ...
        or incomplete, we have the right to suspend or terminate your access and
      ...
      <ul>
        ...
        <li>
          ...
          attempt to learn sensitive information such as private keys.
        </li>
        <li>
      ...
      <p>
        ...
        access for any reason, you are prohibited from using our interface even
      ...
      <p>
        ...
        described below) through binding arbitration (i.e. the referral of a
      ...
      <p>
        ...
        specific personal jurisdiction in any forum outside the BVI.
      </p>
