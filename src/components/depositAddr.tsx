        ...
        <div className='depositBox'>
          ...
          <div>
            ...
            <div>
              Send only{' '}
              <img
                src={'/images/' + p.sD.ticker + '.png'}
                className='chainIcon'
              />{' '}
              {p.sD.token_name} ({p.sD.ticker.toUpperCase()})
            </div>
            <div>
              Minimum Deposit Amount: {p.sD.min_deposit}{' '}
              {p.sD.ticker.toUpperCase()}
            </div>
            <div className='depositAddr'>
              {depositAddr} <CopyButton data={depositAddr} isWhite={true} />
            </div>
          </div>
        </div>
      </>
